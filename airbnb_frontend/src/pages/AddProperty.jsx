      ...
      <div className="max-w-4xl mx-auto bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200 border border-slate-100 p-10">
        ...
        <form onSubmit={submitForm} className="grid md:grid-cols-2 gap-6">
          ...
          <div>
             ...
             <input name="price_per_night" type="number" placeholder="₹" onChange={handleChange} className="w-full border-2 border-slate-50 bg-slate-50/50 rounded-2xl px-5 py-4 font-medium outline-none focus:border-rose-500 focus:bg-white transition" required />
          </div>
